    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-extrabold text-white tracking-tight">Add Metal Price</h1>
                    <p class="text-slate-400 mt-1">Register a new precious metal rate for the bullion market.</p>
                </div>
            ...
            <div class="admin-card p-8">
                <form action="{{ route('admin.metal-prices.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label
                                ...
                                Type</label>
                            <input type="text" name="metal_type" value="{{ old('metal_type') }}"
                                placeholder="e.g. Gold (24K) / Silver"
                        ...
                        <div>
                            <label
                                ...
                                Unit</label>
                            <input type="text" name="unit" value="{{ old('unit', 'Tola') }}"
                                placeholder="e.g. Tola / 10 Grams"
                                class="w-full bg-slate-800/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder-slate-600"
                                required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="currency" value="{{ old('currency', 'NPR') }}"
                    ...
                    <div class="pt-4">
                        <button type="submit"
                            ...
                            Authorize & Publish Market Price
                        </button>
                    </div>
                </form>
            </div>
