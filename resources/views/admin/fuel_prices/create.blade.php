    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-extrabold text-white tracking-tight">Add Fuel Price</h1>
                    <p class="text-slate-400 mt-1">Register a new petroleum product rate for a specific region.</p>
                </div>
            ...
            <div class="admin-card p-8">
                <form action="{{ route('admin.fuel-prices.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="product" value="{{ old('product') }}"
                                placeholder="e.g. Petrol / Diesel / LPG"
